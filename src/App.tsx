    ...
    <div className="flex flex-col h-screen w-screen overflow-hidden bg-[#0A0A0B] font-sans antialiased text-[#E0E0E0] select-none">
      ...
      <div className="hidden md:flex h-8 bg-[#0E0E10] border-b border-[#222224] items-center justify-between px-3 shrink-0 select-none app-drag-region z-40">
        ...
        <div className="flex items-center gap-2 text-[11px] text-gray-500 font-mono">
          ...
          <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#1C1C1E] text-gray-400 border border-[#222224]">v1.3.2</span>
        </div>
      </div>
          ...
          <header className="md:hidden h-10 bg-[#111112] border-b border-[#222224] px-2.5 flex items-center justify-between shrink-0 select-none z-20">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-1.5 font-bold text-xs text-white">
                ...
                <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#1C1C1E] text-gray-400 border border-[#222224] font-mono font-normal">v1.3.2</span>
              </div>
            </div>
