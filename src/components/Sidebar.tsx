  ...
  const sections = [
    {
      ...
      items: [
        ...
        { id: 'terminal', label: 'Terminal (SSH)', icon: Terminal, badge: activeTabsCount > 0 ? activeTabsCount : undefined },
    ...
    <div className="flex flex-col h-full overflow-hidden">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-bold text-sm tracking-tight text-white flex items-center gap-1.5">
              ...
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-[#1C1C1E] text-gray-400 border border-[#222224] font-mono">v1.3.1</span>
            </div>
      ...
      <div className="p-3 border-t border-[#222224] bg-[#111112] space-y-2">
        ...
        <div className="flex items-center justify-between px-1 text-gray-500 text-[11px]">
          ...
          <span className="font-mono text-[10px] text-gray-400">v1.3.1</span>
        </div>
      </div>
    </div>
  );
